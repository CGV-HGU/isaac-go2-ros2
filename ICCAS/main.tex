...
\caption{\label{fig_system_overview}Overall architecture of the proposed legged navigation system. In simulation, an RL locomotion policy generates realistic camera shaking noise. In physical deployment, commands are routed to the Unitree Sport API via a lightweight bridge to save edge computation.}
\end{center}
\end{figure}
