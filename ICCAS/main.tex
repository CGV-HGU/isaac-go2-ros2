...
\begin{center}
\vspace{-2mm}
\includegraphics[width=0.48\linewidth]{figures/fig_3d_map.png}
\hfill
\includegraphics[width=0.48\linewidth]{figures/fig_2d_map.png}
\vspace{-2mm}
\caption{\label{fig_sim_validation}Visual mapping results in the virtual sandbox. Left: Reconstructed 3D point cloud map from RTAB-Map. Right: Projected 2D occupancy grid map.}
\vspace{-4mm}
\end{center}
\end{figure}
