...
\begin{center}
\vspace{-2mm}
\includegraphics[width=0.55\linewidth]{figures/fig_3dgs_mesh.png}
\vspace{-2mm}
...
\begin{figure*}[t]
\begin{center}
\includegraphics[width=0.44\textwidth]{figures/fig_sim_nav2.png}
\hfill
\includegraphics[width=0.22\textwidth]{figures/fig_3d_map.png}
\hfill
\includegraphics[width=0.22\textwidth]{figures/fig_2d_map.png}
\caption{\label{fig_sim_validation}Simulation validation results in the virtual sandbox. (a) Nav2 navigation stack active in the 3DGS environment, showing the simulated quadruped in Isaac Sim (left) and path planning/costmap in RViz (right). (b) Reconstructed 3D point cloud map from RTAB-Map. (c) Projected 2D occupancy grid map.}
\end{center}
\end{figure*}
