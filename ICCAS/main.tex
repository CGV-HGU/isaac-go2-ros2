...
\begin{figure}[thb]
\begin{center}
\includegraphics[width=0.75\linewidth]{figures/fig_3d_map.png} \\ \vspace{0.5mm}
\includegraphics[width=0.75\linewidth]{figures/fig_2d_map.png}
\caption{\label{fig_sim_validation}Visual SLAM mapping results inside the Oseok Hall corridor. (a) Reconstructed 3D point cloud map. (b) Projected 2D occupancy grid map used for path planning and navigation.}
\end{center}
\end{figure}
...
\begin{figure}[thb]
\begin{center}
\includegraphics[width=0.7\linewidth]{figures/fig_real_robot.jpg}
