...
\begin{enumerate}
    ...
    \item We present a resource-efficient deployment architecture that interfaces high-level ROS 2 navigation commands with the robot's native Sport API, achieving successful direct transfer of parameters tuned under simulated bobbing noise onto the physical robot without real-world retuning.
\end{enumerate}
