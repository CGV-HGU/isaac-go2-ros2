...
# 사용자님이 요청하신 정확한 명령어
./isaaclab.sh -p scripts/reinforcement_learning/skrl/evaluate_nav.py --task Isaac-Velocity-Flat-Unitree-Go2-v0 --num_envs 1 +checkpoint="logs/skrl/unitree_go2_flat/2026-04-1413-12-51_ppo_torch/checkpoints/best_agent.pt"
